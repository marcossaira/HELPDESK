<?php
class formViewListaEspera{
  public function formViewListaEsperaShow($datos) 
  {
    ?>
...
<body>
    <form name='formViewListaEspera' enctype="multipart/form-data" method='POST' action="../workerModule/getWorker.php">

        <table>
            <tr>
                <td>
                    <h1>REQUERIMIENTOS EN ESPERA</h1>
                </td>
        ...
        <table class="table" style='margin-top:100px'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src='../images/evidence/' width=70px></td>
                    <td>
