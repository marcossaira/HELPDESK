<?php
class formViewAtendidos{
  public function formViewAtendidosShow($datos) 
  {
    ?>
...
<body>
    <form name='formViewAtendidos' enctype="multipart/form-data">

        <table>
            <tr>
                <td>
                    <h1>REQUERIMIENTOS ATENDIDOS</h1>
                </td>
        ...
        <table class="table" style='margin-top:100px'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $datos[$i]['nomTrabajador'] ?> <?php echo $datos[$i]['apeTrabajador'] ?>
                    </td>
                    <td>
                        <?php echo $datos[$i]['fechaCambio'] ?>
                    </td>
                    <td>
                        <?php echo $datos[$i]['horaCambio'] ?>
                    </td>
