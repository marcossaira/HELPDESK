<?php
class formViewSuspendido{
  public function formViewSuspendidoShow($datos) 
  {
    ?>
...
<body>
    <form name='formViewSuspendido' enctype="multipart/form-data">

        <table>
            <tr>
                <td>
                    <h1>REQUERIMIENTOS SUSPENDIDOS</h1>
                </td>
